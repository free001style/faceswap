...
class FLAME(nn.Module):
    ...
    def __init__(self, config, path):
        ...
        shapedirs = torch.cat([shapedirs[:, :, :config.model.n_shape], shapedirs[:, :, 300:300 + config.model.n_exp]],
                              2)
        ...
        lmk_embeddings = np.load('./models/deca/data/landmark_embedding.npy', allow_pickle=True, encoding='latin1')
