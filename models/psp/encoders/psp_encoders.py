...
class Inverter32(nn.Module):
    def __init__(self, n_styles=18, opts=None):
        ...
        self.fs_backbone = FSLikeBackbone32(opts=opts, n_styles=n_styles)
        self.fuser = ContentLayerDeepFast(6, 1024, 512)

class FSLikeBackbone32(FSLikeBackbone):
    def __init__(self, n_styles=18, opts=None):
        super(FSLikeBackbone, self).__init__()

        resnet50 = iresnet50()
        resnet50.load_state_dict(torch.load("pretrained_ckpts/auxiliary/iresnet50-7f187506.pth"))
