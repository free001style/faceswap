...
#         out = features
#         i = start
#         j = 3 if start == 7 else 2
#         for conv1, conv2, noise1, noise2, to_rgb in zip(
#                 self.convs[start - 1::2], self.convs[start::2], noise[start - 4::2], noise[start - 3::2], self.to_rgbs[j:]
#         ):
#             out = conv1(out, latent[:, i], noise=noise1)
#             out = conv2(out, latent[:, i + 1], noise=noise2)
            
#             if early_stop is not None and early_stop == 2 ** i:
#                 return out
