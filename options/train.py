...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--ffhq_dataset_root', default='./ffhq/images', type=str,
        ...
        self.parser.add_argument('--pl_lambda', default=10.0, type=float, help='PL loss multiplier factor')
        ...
        self.parser.add_argument('--sfe_inverter_path', default='./pretrained_ckpts/inverter/sfe_inverter.pt',
                                 type=str,
                                 help='Path to sfe')
        self.parser.add_argument('--fse_path', default='./pretrained_ckpts/inverter/143_enc.pth',
                                 type=str,
                                 help='Path to fse')
        self.parser.add_argument('--e4e_path', default='./pretrained_ckpts/e4e_ffhq_encode.pt',
                                 type=str,
                                 help='Path to e4e')
        self.parser.add_argument('--face_parsing_path', default='./pretrained_ckpts/79999_iter.pth',
                                 type=str,
                                 help='Path to face_parsing')
