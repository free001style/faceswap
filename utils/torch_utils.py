...
def vis_faces(log_hooks1, flag):
    ...
    for i in range(display_count):
        ...
        vis_faces_no_id(hooks_dict1, fig, gs, i, flag)

    plt.tight_layout()
    return fig


def vis_faces_no_id(hooks_dict1, fig, gs, i, flag):
    if flag:
        plt.imshow(hooks_dict1['source_recon'])
        plt.title('source_recon')
        ...
        plt.imshow(hooks_dict1['target_recon'])
        plt.title('target_recon')
